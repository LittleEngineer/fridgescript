/*
    This file is part of FridgeScript and FSAssembler.

    FridgeScript and FSAssembler are free software: you can redistribute them and/or modify
    them under the terms of the GNU Lesser General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    FridgeScript and FSAssembler are distributed in the hope that they will be useful,
...
namespace Simple
{
	...
	public:
		...
		ListNode& operator =(const ListNode<T>& n)
		{
			value = n.value;
			prev = n.prev;
			next = n.next;
	...
	{
	protected:
		Array<ListNode<T>> nodes;
		ListNode* start;
		ListNode* end;
	public:
		List<T>() : nodes(), start(0), end(0)
		{
		}
		...
		inline void Prepend(const T& data)
		{
			ListNode newNode;
			newNode.value = T;
			newNode.next = start;
